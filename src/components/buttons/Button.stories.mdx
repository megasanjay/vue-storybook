...
This is a third type of button that is used for less important actions. It is used to reduce the visual weight of the button in the interface. It is also used to show the user that the action is not the main action of the page.
